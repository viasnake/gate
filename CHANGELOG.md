...
## [0.67.0](https://github.com/viasnake/gate/compare/v0.66.15...v0.67.0) (2026-06-13)


### Features

* Add BungeeGuard Compatible mode ([#390](https://github.com/viasnake/gate/issues/390)) ([f62d8c4](https://github.com/viasnake/gate/commit/f62d8c40918d9fb2e55637910df02b7f6b2e63dc))
...
* add KickPlayerRaw handler for bungeecord plugin channel ([1d21188](https://github.com/viasnake/gate/commit/1d21188d85ee523c0d73216f19bac35ff990b789))
...
* add note about cached results ([5d26598](https://github.com/viasnake/gate/commit/5d26598073a3b9527a140a93cc4f18430954fb3b))
...
* Allow setting custom mojang authentication server ([#264](https://github.com/viasnake/gate/issues/264)) ([91e3d7e](https://github.com/viasnake/gate/commit/91e3d7e6d42e8900044b4ca7857edbdc7625c3ba))
...
* Extensions/Projects page on the Gate Website ([#424](https://github.com/viasnake/gate/issues/424)) ([81a1528](https://github.com/viasnake/gate/commit/81a1528d1823f4f21682ff6d5100713d338619b2))
* Gate HTTP API ([#423](https://github.com/viasnake/gate/issues/423)) ([e960e6b](https://github.com/viasnake/gate/commit/e960e6b45bd6c6cee5e65351d88a99d7d47e9393))
...
* Minecraft 1.20.2-4 support ([#258](https://github.com/viasnake/gate/issues/258)) ([d6f4446](https://github.com/viasnake/gate/commit/d6f444697638796cf0c5c986974f9396d4dfc876))
...
* **ui:** improve search mode toggle visibility and naming ([6aea92c](https://github.com/viasnake/gate/commit/6aea92c36b363ae42827ad706eda117e77adfe31))
* Update 1.21 protocol to include 1.21.1 ([c98a677](https://github.com/viasnake/gate/commit/c98a677436671e949bfdc082e81631dd6568e37d))
...
* Add missing duration unit ([b8a2e67](https://github.com/viasnake/gate/commit/b8a2e67b901bd1e58c2026d90748107e01253796))
...
* connection timeout duration ([f2a0488](https://github.com/viasnake/gate/commit/f2a0488f170208251d9fc50bfa85c8879d139a32))
...
* **deps:** update github.com/pires/go-proxyproto digest to b718e7c ([#323](https://github.com/viasnake/gate/issues/323)) ([9992ad4](https://github.com/viasnake/gate/commit/9992ad4fc6bcd899ca27a8ee17376af80476cb04))
* **deps:** update golang.org/x/exp digest to 701f63a ([#375](https://github.com/viasnake/gate/issues/375)) ([f73fd4b](https://github.com/viasnake/gate/commit/f73fd4beb155442a6691d3bb711671896ef1e5dc))
...
* **deps:** update module buf.build/gen/go/minekube/gate/connectrpc/go to v1.17.0-20241120101512-f1a10b5029ce.1 ([#429](https://github.com/viasnake/gate/issues/429)) ([6f458b3](https://github.com/viasnake/gate/commit/6f458b38e1a78cc9aa077304ea7a77c13f7bd89f))
...
* **deps:** update module buf.build/gen/go/minekube/gate/protocolbuffers/go to v1.35.2-20241120101512-f1a10b5029ce.1 ([#430](https://github.com/viasnake/gate/issues/430)) ([3bd983e](https://github.com/viasnake/gate/commit/3bd983e4a6dbd20ee501ddaa14102f4e62395e0c))
...
* **deps:** update module github.com/go-faker/faker/v4 to v4.2.1 ([0f049b3](https://github.com/viasnake/gate/commit/0f049b363ea3238543cd2226df133d3ba72b63c4))
* **deps:** update module github.com/go-faker/faker/v4 to v4.3.0 ([eff7c06](https://github.com/viasnake/gate/commit/eff7c06a017da70216faa2da5c5805232acf7f58))
* **deps:** update module github.com/go-faker/faker/v4 to v4.4.0 ([f945ce3](https://github.com/viasnake/gate/commit/f945ce3cdeab5ccc83ad8140fe7b62a5f9f6a8e5))
* **deps:** update module github.com/go-faker/faker/v4 to v4.4.1 ([3383a57](https://github.com/viasnake/gate/commit/3383a57c3f73b682218b244a4d25ca34a344e2f4))
* **deps:** update module github.com/go-faker/faker/v4 to v4.4.2 ([2c297e3](https://github.com/viasnake/gate/commit/2c297e3507d45cf30ca1c6a8dfc8339cf1914c2f))
* **deps:** update module github.com/go-faker/faker/v4 to v4.5.0 ([5fdd7c1](https://github.com/viasnake/gate/commit/5fdd7c190e05cb1935c159b81e1638c50210b53e))
...
* **deps:** update module github.com/go-logr/logr to v1.4.2 ([63f9b66](https://github.com/viasnake/gate/commit/63f9b66ad951263d9395f1db14b7e1a63a91ca80))
* **deps:** update module github.com/google/uuid to v1.6.0 ([3350975](https://github.com/viasnake/gate/commit/3350975ea6639c38cdf69705a5870e825047694f))
...
* **deps:** update module github.com/jellydator/ttlcache/v3 to v3.2.0 ([73c9303](https://github.com/viasnake/gate/commit/73c93033f9fac6b1de4fb18aab0a9641bc416476))
* **deps:** update module github.com/jellydator/ttlcache/v3 to v3.2.1 ([5cf2af8](https://github.com/viasnake/gate/commit/5cf2af817ac910bbce22ce139a61ac2b843b2eec))
* **deps:** update module github.com/jellydator/ttlcache/v3 to v3.3.0 ([b38fb74](https://github.com/viasnake/gate/commit/b38fb741c8045dac1a1a5b79add4a95753918c7a))
* **deps:** update module github.com/knadh/koanf/providers/file to v1.1.1 ([1689d66](https://github.com/viasnake/gate/commit/1689d661f23cfb046232fcaa105c9b35a901846f))
* **deps:** update module github.com/knadh/koanf/providers/file to v1.1.2 ([8476477](https://github.com/viasnake/gate/commit/84764772827729d1459dcf9e3005fdb5c82317a8))
...
* **deps:** update module github.com/pires/go-proxyproto to v0.8.0 ([3114d14](https://github.com/viasnake/gate/commit/3114d1484aea67b91da6fafce60f7db75177413b))
...
* **deps:** update module github.com/rs/xid to v1.6.0 ([ecbef7f](https://github.com/viasnake/gate/commit/ecbef7f8a0a259433fc7a152c1c94a228308c515))
* **deps:** update module github.com/sandertv/go-raknet to v1.13.0 ([23d050a](https://github.com/viasnake/gate/commit/23d050a5f2a3ec2ebafd458b86f0520d1a5fd6c7))
* **deps:** update module github.com/sandertv/gophertunnel to v1.35.0 ([d49211d](https://github.com/viasnake/gate/commit/d49211d4e2de6f1e0f410a23cdc8d37f415532f5))
* **deps:** update module github.com/sandertv/gophertunnel to v1.36.0 ([c09a5ef](https://github.com/viasnake/gate/commit/c09a5ef268ce7c151b75198c5c54c22c999da1a2))
* **deps:** update module github.com/sandertv/gophertunnel to v1.36.1 ([8d9a362](https://github.com/viasnake/gate/commit/8d9a362d19a3f5acb98bbad88c67d1e531d8cb76))
* **deps:** update module github.com/sandertv/gophertunnel to v1.37.0 ([b818384](https://github.com/viasnake/gate/commit/b8183844ad1891b7ae49b4cc199e76a3d59eacb9))
* **deps:** update module github.com/spf13/viper to v1.19.0 ([69bdd16](https://github.com/viasnake/gate/commit/69bdd16042971b858489908cf61d6be67eaa6c60))
...
* **deps:** update module github.com/stretchr/testify to v1.9.0 ([f7c6a6b](https://github.com/viasnake/gate/commit/f7c6a6b4ae25d491b59367211d011fbe377f1d4e))
* **deps:** update module github.com/tnze/go-mc to v1.20.2 ([0a6de01](https://github.com/viasnake/gate/commit/0a6de01b6dc036d258a5d30ce2a64745c3dfa16d))
* **deps:** update module github.com/urfave/cli/v2 to v2.27.2 ([962df75](https://github.com/viasnake/gate/commit/962df75e974a49903e0bb5cd8364aef08b3e6d6e))
* **deps:** update module github.com/urfave/cli/v2 to v2.27.3 ([6c7235e](https://github.com/viasnake/gate/commit/6c7235e8f49b62cbdaf82eeb76a7af37ce05abb1))
* **deps:** update module github.com/urfave/cli/v2 to v2.27.4 ([a1aa419](https://github.com/viasnake/gate/commit/a1aa419f3ad29b86db7edd8970c714e1f3bc1fac))
* **deps:** update module github.com/urfave/cli/v2 to v2.27.5 ([fc11e84](https://github.com/viasnake/gate/commit/fc11e84fdf2ba6560813244daee32fb118439fb8))
...
* **deps:** update module go.minekube.com/gate to v0.36.4 ([e897760](https://github.com/viasnake/gate/commit/e897760ff8bb30e46e387229e0b03fb62d1bea92))
* **deps:** update module go.minekube.com/gate to v0.36.5 ([dee5106](https://github.com/viasnake/gate/commit/dee51064e1b7f76cdceb96a6462a79f9707a5a4e))
* **deps:** update module go.minekube.com/gate to v0.36.7 ([7f9d349](https://github.com/viasnake/gate/commit/7f9d349bfc53ae1cbb1e39a34d0f236b45ce7a82))
* **deps:** update module go.minekube.com/gate to v0.37.0 ([#343](https://github.com/viasnake/gate/issues/343)) ([014b18f](https://github.com/viasnake/gate/commit/014b18f18ec6bc7d67a21e4b6fd57684beb0c373))
* **deps:** update module go.minekube.com/gate to v0.37.1 ([e97381a](https://github.com/viasnake/gate/commit/e97381a307313da2731abdce7cddfb6ac23a3302))
* **deps:** update module go.minekube.com/gate to v0.38.0 ([da9f947](https://github.com/viasnake/gate/commit/da9f947d0a619c83b89c06a6fd7ed810d55d28d3))
* **deps:** update module go.minekube.com/gate to v0.38.1 ([3ebcb74](https://github.com/viasnake/gate/commit/3ebcb744e540dba019e90c91c4e6961523d5027c))
* **deps:** update module go.minekube.com/gate to v0.38.2 ([fc6f8c4](https://github.com/viasnake/gate/commit/fc6f8c4b43f1ab38797e2bfbd191b55cf97e4957))
* **deps:** update module go.minekube.com/gate to v0.39.2 ([c101a4f](https://github.com/viasnake/gate/commit/c101a4f211b3b47c4e7afdfa379d97069bacec7e))
* **deps:** update module go.minekube.com/gate to v0.39.3 ([e05d2ac](https://github.com/viasnake/gate/commit/e05d2ac489d10f6aa0341489ecf9441e2331b2bd))
* **deps:** update module go.minekube.com/gate to v0.40.0 ([cfd00e8](https://github.com/viasnake/gate/commit/cfd00e892295994f28709f07b63380c705adea66))
* **deps:** update module go.minekube.com/gate to v0.41.0 ([9e0c531](https://github.com/viasnake/gate/commit/9e0c53126dd89b911e00318d230f3f9466a05373))
* **deps:** update module go.minekube.com/gate to v0.41.2 ([947e48b](https://github.com/viasnake/gate/commit/947e48b505a4f249c3cb024e7aaba231f4debac4))
* **deps:** update module go.minekube.com/gate to v0.42.0 ([9a51e72](https://github.com/viasnake/gate/commit/9a51e7231917a3b4e4c47b95fdb44b683a0ee37d))
* **deps:** update module go.minekube.com/gate to v0.42.1 ([82be2c2](https://github.com/viasnake/gate/commit/82be2c22b212e042e5068f8324927e3050263765))
* **deps:** update module go.minekube.com/gate to v0.42.2 ([#426](https://github.com/viasnake/gate/issues/426)) ([ef6d83f](https://github.com/viasnake/gate/commit/ef6d83f4369e75e1ad39e0ad0fd86c59b7ea03e2))
...
* **deps:** update module go.uber.org/zap to v1.27.0 ([ee89f5b](https://github.com/viasnake/gate/commit/ee89f5ba4ab538743132ffdbe0443bce922e54c1))
...
* **deps:** update module golang.org/x/sync to v0.7.0 ([a213cbd](https://github.com/viasnake/gate/commit/a213cbd32d2b49358c23f4e13df6d97b1dc058d3))
* **deps:** update module golang.org/x/sync to v0.8.0 ([0e83a98](https://github.com/viasnake/gate/commit/0e83a98767f9e502ab7bc3011f4a123cda84e500))
* **deps:** update module golang.org/x/sync to v0.9.0 ([#418](https://github.com/viasnake/gate/issues/418)) ([c94333d](https://github.com/viasnake/gate/commit/c94333dafeda3e18127d6b0d18fbaadff0d215c5))
* **deps:** update module golang.org/x/text to v0.15.0 ([59a0491](https://github.com/viasnake/gate/commit/59a049183bb4649bd4889724c5a70a3778445d06))
* **deps:** update module golang.org/x/text to v0.16.0 ([d1a521a](https://github.com/viasnake/gate/commit/d1a521a4f1cef854ff48e2511cc5e822a2853cc4))
* **deps:** update module golang.org/x/text to v0.18.0 ([89bd837](https://github.com/viasnake/gate/commit/89bd837eb8abc0642aa36b22325a2aa1bcdcf0eb))
* **deps:** update module golang.org/x/text to v0.19.0 ([011939f](https://github.com/viasnake/gate/commit/011939f8e994fc20ca212afb37e51bb643d2d055))
* **deps:** update module golang.org/x/text to v0.20.0 ([#419](https://github.com/viasnake/gate/issues/419)) ([220582c](https://github.com/viasnake/gate/commit/220582c36bb7e660166ee497c7a9b2d734b561c7))
...
* **deps:** update module golang.org/x/time to v0.6.0 ([468513d](https://github.com/viasnake/gate/commit/468513d0bb8cb10bb61bf1417d532019b86b78a8))
* **deps:** update module golang.org/x/time to v0.7.0 ([2457473](https://github.com/viasnake/gate/commit/2457473590b885844989f8e1b9e60a37f17da304))
* **deps:** update module golang.org/x/time to v0.8.0 ([#420](https://github.com/viasnake/gate/issues/420)) ([7b46c4c](https://github.com/viasnake/gate/commit/7b46c4c4dbdb7abfc3c478e65ccf00ecb153a4c3))
...
* **deps:** update module google.golang.org/grpc to v1.61.0 ([b201e6b](https://github.com/viasnake/gate/commit/b201e6bbd3cd69bf2913c08c1bf4d6a32a187799))
* **deps:** update module google.golang.org/grpc to v1.61.1 ([34e370b](https://github.com/viasnake/gate/commit/34e370b4dfad167bd0db4718c4d761b155724a54))
* **deps:** update module google.golang.org/grpc to v1.62.0 ([d36cc68](https://github.com/viasnake/gate/commit/d36cc68c83d1a2f96ebc6e11bcef1612f94515cc))
* **deps:** update module google.golang.org/grpc to v1.62.1 ([ddd43cb](https://github.com/viasnake/gate/commit/ddd43cb43c49d5f3db204a40dce8a82cb2aaa08a))
* **deps:** update module google.golang.org/grpc to v1.63.0 ([11e81c5](https://github.com/viasnake/gate/commit/11e81c5492ead7592d21d601a5b37a3c97e0635f))
* **deps:** update module google.golang.org/grpc to v1.63.2 ([ea86cca](https://github.com/viasnake/gate/commit/ea86cca74e6f157702ab15b588ea9e83fa008bd5))
* **deps:** update module google.golang.org/grpc to v1.64.0 ([a01e8b0](https://github.com/viasnake/gate/commit/a01e8b052289588b7b8851decc3e284990f3dfb2))
* **deps:** update module google.golang.org/grpc to v1.65.0 ([cfe9ed0](https://github.com/viasnake/gate/commit/cfe9ed020e18d794322cb99547f2e655962be87d))
* **deps:** update module google.golang.org/grpc to v1.66.0 ([bf9aa22](https://github.com/viasnake/gate/commit/bf9aa22f123b16deec0e28cc8b78b9e48c676221))
* **deps:** update module google.golang.org/grpc to v1.66.2 ([9ecb33c](https://github.com/viasnake/gate/commit/9ecb33cf867678b6f80ff44db425bb766231aa5e))
* **deps:** update module google.golang.org/grpc to v1.67.0 ([#389](https://github.com/viasnake/gate/issues/389)) ([7cc97ab](https://github.com/viasnake/gate/commit/7cc97ab2083d54e008ba0fbff71039e9bc96c0d1))
* **deps:** update module google.golang.org/grpc to v1.67.1 ([ee304c9](https://github.com/viasnake/gate/commit/ee304c928a4dd776e0dbd389f54d7079f8e71499))
* **deps:** update module google.golang.org/grpc to v1.68.0 ([#421](https://github.com/viasnake/gate/issues/421)) ([4916245](https://github.com/viasnake/gate/commit/491624518aa52800530210af01211f67acd84dc0))
...
* **deps:** update module nhooyr.io/websocket to v1.8.11 ([7953aef](https://github.com/viasnake/gate/commit/7953aefae5f52b165ec4dce3e6aae74cde05cb62))
...
* **docs:** Disabling response cache ([0b3b733](https://github.com/viasnake/gate/commit/0b3b733dc3bdede11873fce5f52704ef2ec519cf))
...
* **docs:** Pageview ([c9b4822](https://github.com/viasnake/gate/commit/c9b48220be7b8395e2b58b521a2e0b9ea2313b78))
...
* Double slash commands (closes [#414](https://github.com/viasnake/gate/issues/414)) ([a6ae8b3](https://github.com/viasnake/gate/commit/a6ae8b34605e79e8be8d8c2d1020bbdbc19732ae))
* Entity/player suggestions in commands ([c443620](https://github.com/viasnake/gate/commit/c443620bb84f66f3d334ec6e86fb66d9069cff6d))
...
* Join/switch server pre-1.20.2 ([083226c](https://github.com/viasnake/gate/commit/083226c6009005a7a2fa5c9fc569e7d3d49361b6))
* JSON Decode ServerPing with string as description ([141278e](https://github.com/viasnake/gate/commit/141278e72921867adb1a5e8df54d50d303927e86))
* Json to Snbt string escaping ([25208f9](https://github.com/viasnake/gate/commit/25208f9cdfd092756bd405dad65114fa7a6be84b))
* **JsonToSNBT:** Always quote string values ([9584d7e](https://github.com/viasnake/gate/commit/9584d7e31023948d270b4de01c5fecec7af70ec4))
* light mode text hover ([84544ea](https://github.com/viasnake/gate/commit/84544ea7be54cc1995bf628c05a5bea2798b1804))
...
* **Lite:** nil pointer dereference caused by defer and return nil when could not write handshake packet ([6e35d73](https://github.com/viasnake/gate/commit/6e35d7304b5c64b92b3e036d56e38170f238f628))
...
* out-of-order disconnects by using chat queue ([231cd43](https://github.com/viasnake/gate/commit/231cd4374f4bd210f4b2e9cba58bb922907e0d9d))
* out-of-order disconnects by using chat queue ([996f54b](https://github.com/viasnake/gate/commit/996f54b89809152f322d6950b5034f7dbf4ce862))
...
* proxyproto: invalid address ([4030e57](https://github.com/viasnake/gate/commit/4030e5772a4c9f15cf96c8e8008853b11def752b))
* register 0x4C ID for Respawn packet in 1.21.2+ ([#416](https://github.com/viasnake/gate/issues/416)) ([f07cdc8](https://github.com/viasnake/gate/commit/f07cdc8714754e92a747ac61990299b436627779))
* remove debug printf ([96c0a2e](https://github.com/viasnake/gate/commit/96c0a2e9f8bd4d91849bba08fbcd8d1d6dc04a79))
...
* Switch server and some data races ([896441b](https://github.com/viasnake/gate/commit/896441b1f6063b3c9307339f256721544bf0164d))
* **ui:** improve search mode toggle visibility ([6fc2b28](https://github.com/viasnake/gate/commit/6fc2b28e44697bc804b0edc4099aea81616c7318))
